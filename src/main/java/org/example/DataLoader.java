...
public class DataLoader {
    private Map<Curs, List<Student>> dataMap;
    ...
    private void loadCourses() throws IOException {
        ...
        for (String courseInputDatum : courseInputData) {
            ...
            Curs cursNou = createCourse(data);
            dataMap.put(cursNou, new ArrayList<>());
        }
    }

    private Curs createCourse(String[] data) {
        int id = Integer.parseInt(data[0]);
        String name = data[1];
        double price = Double.parseDouble(data[2]);

        LocalDate dataInceput = LocalDate.parse(data[3]);
        Curs cursNou = new Curs(id, name, price, dataInceput);
    ...
    private Student creareStudent(String[] dateDespreStudent) {
        ...
        Double buget = Double.parseDouble(dateDespreStudent[2]);
    ...
    private void mapStudentsToCourses() throws IOException {
        ...
        for(String mapare: listaMapping) {
            String[] iduri = mapare.split(","); // "5123,123123" => ["5123", "123123"]
            ...
            if (studentGasit != null && cursGasit != null) {
                ...
                double bugetStudent = studentGasit.getBugetStudent();
    ...
    public Map<Curs, List<Student>> getDataMap() {
        return dataMap;
    }
